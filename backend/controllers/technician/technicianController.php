...
class TechnicianControllerClass
{
    ...
    public static function getDeletedTickets(): string
    {
        ...
        foreach ($result as $row) {
            ...
            $html .= '<a href="../../../backend/scripts/technician/restoreTechnician-script.php?id=' . htmlspecialchars($row['id']) . '&alert=service_deleted" class="btn hover-effect d-flex align-items-center gap-2 text-info dropdown-item"><span class="material-symbols-outlined">replay</span>RESTORE</a>';
    ...
    public static function getTechnician(): string
    {
        ...
        foreach ($result as $row) {
            ...
            // Add the "Rate" option in the dropdown
            // $html .= '<a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#ratingFormModal"' . $row['id'] . '">Rate</a>';
            $html .= '<a href="../../../backend/scripts/technician/deleteTechnician-script.php?id=' . htmlspecialchars($row['id']) . '&alert=service_deleted" class="btn hover-effect d-flex align-items-center gap-2 text-danger dropdown-item"><span class="material-symbols-outlined">delete</span>DELETE</a>';
