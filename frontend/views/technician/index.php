...
include '../../../backend/controllers/technician/technicianController.php';
?>
<!doctype html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="page-title">
                                    <h5>Manage Technician</h5>
                                    <h6 class="sub-heading">Manage, Add and Edit Technician</h6>
                                </div>
                            </div>
                            <!-- <div class="col-sm-4">
                                ...
                                <div class="card-header d-flex justify-content-between">
                                    <a data-bs-toggle="modal" data-bs-target="#addNewServiceModal"
                                        class="btn btn-primary d-flex gap-2 align-items-center"><span
                                            class="icon-plus-outline"></span>Create a Technician</a>

                                    <a data-bs-toggle="modal" data-bs-target="#archivedUserModal"
                                        class="btn btn-danger d-flex gap-2 align-items-center"><span
                                            class="material-symbols-outlined">
                                            settings_backup_restore
                                        </span></span>Deleted Technician</a>
                                </div>
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th scope="col">TECHNICIAN CREATED</th>
                                                <th scope="col">CREATED ON</th>
                                                <th scope="col">ACTIONS</th>
                                            </tr>
                                        </thead>
                                        <tbody class="py-5">
                                            <?php echo TechnicianControllerClass::getTechnician(); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class=" modal-content">
                                <div class="modal-body">
                                    <form action="../../../backend/scripts/technician/addTechnician-script.php" method="post"
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-12 d-flex flex-column gap-5">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="form-group w-100">
                                                        <label for="technician_name" class="py-2 text-muted">TECHNICIAN NAME:<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control h-75 w-100"
                                                            id="technician_name"
                                                            placeholder="Technician Name" name="technician_name"
                                                            required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer mt-5">
                                            <button type="submit" class="btn btn-primary mt-3 py-3 px-5 w-auto"
                                                name="add_account">CREATE TECHNICIAN</button>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class=" modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="archivedUserModalLabel">Restore deleted technician
                                    </h1>
                                ...
                                <div class="modal-body">
                                    <div class="card-body" style="height: 80vh; overflow-y: auto;">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody class="p-5">
                                                <?php echo TechnicianControllerClass::getDeletedTickets(); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
